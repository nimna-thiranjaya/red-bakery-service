...
import com.redbakery.redbakeryservice.util.StatusCode;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CommonResponse> handleBadeRequestException(Exception e) {
        return new ResponseEntity<CommonResponse>(
                new CommonResponse(false, StatusCode.BAD_REQUEST.getCode(), e.getMessage(), Instant.now(), null),
    ...
    public ResponseEntity<CommonResponse> handleNotFoundException(Exception e) {
        return new ResponseEntity<CommonResponse>(
                new CommonResponse(false, StatusCode.NOT_FOUND.getCode(), e.getMessage(), Instant.now(), null),
    ...
    public ResponseEntity<CommonResponse> handleCConflictException(Exception e) {
        return new ResponseEntity<CommonResponse>(
                new CommonResponse(false, StatusCode.CONFLICT.getCode(), e.getMessage(), Instant.now(), null),
                HttpStatus.CONFLICT
        );
    }
    ...
    public ResponseEntity<CommonResponse> handleForbiddenException(Exception e) {
        return new ResponseEntity<CommonResponse>(
                new CommonResponse(false, StatusCode.FORBIDDEN.getCode(), e.getMessage(), Instant.now(), null),
    ...
    public ResponseEntity<CommonResponse> handleInternalServerException(Exception e){
        return new ResponseEntity<CommonResponse>(
                new CommonResponse(false, StatusCode.INTERNAL_SERVER_ERROR.getCode(), e.getMessage(), Instant.now(), null),
